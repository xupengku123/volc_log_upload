 ...
 */
typedef void(^VeCancellationBlock)(void);

/*!
 The consumer view of a CancellationToken.
 Propagates notification that operations should be canceled.
 A VeCancellationToken has methods to inspect whether the token has been cancelled.
 */
@interface VeCancellationToken : NSObject
 ...
 */
- (VeCancellationTokenRegistration *)registerCancellationObserverWithBlock:(VeCancellationBlock)block;
